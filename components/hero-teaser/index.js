...
const {
  ...
  description,
  heroImageContainer,
  heroContainerIllustration1,
  heroContainerIllustration2,
  ...
  return (
    <div className={heroWrapper}>
      <div className={heroContainer}>
        <div className={heroContainerIllustration1}></div>
        ...
        <div className={customShapeDividerBottom}>
          <svg
            data-name='Layer 1'
